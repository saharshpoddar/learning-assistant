 ...
 *   <li>{@link server.learningresources.model.ResourceType} — content format: documentation, tutorial, blog, book, video, etc. (10 values)</li>
 *   <li>{@link server.learningresources.model.ResourceCategory} — broad technology domain: java, python, web, devops, etc. (15 values)</li>
 *   <li>{@link server.learningresources.model.ConceptArea} — fine-grained CS/SE concepts: concurrency, testing, design-patterns, etc. (33 values)</li>
