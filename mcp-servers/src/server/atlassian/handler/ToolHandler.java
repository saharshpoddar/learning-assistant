 ...
 * </ul>
 *
 * <p><strong>Registered Tools (17 total):</strong>
 * <ul>
 *   <li>Jira (7): search_issues, get_issue, create_issue, update_issue, transition_issue, list_projects, get_sprint</li>
 *   <li>Confluence (5): search, get_page, create_page, update_page, list_spaces</li>
 *   <li>Bitbucket (5): list_repos, get_repo, list_pull_requests, get_pull_request, search_code</li>
 * </ul>
 */
public class ToolHandler {
    ...
    public ToolHandler(final ConnectionConfig jiraConfig,
        ...
        this.jiraHandler = new JiraHandler(new JiraClient(jiraConfig));
        this.confluenceHandler = new ConfluenceHandler(new ConfluenceClient(confluenceConfig));
        this.bitbucketHandler = new BitbucketHandler(new BitbucketClient(bitbucketConfig));
    }
